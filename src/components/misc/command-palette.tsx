  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden border border-border/60 bg-background/70 px-1.5 py-0.5 text-[10px] leading-none text-muted-foreground sm:inline">
          ⌘K
        </span>
      </button>
              ...
              {filteredActions.map((action, index) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "flex size-8 shrink-0 items-center justify-center border border-border/60 bg-background/60 text-primary transition-colors",
                    ...
                    <span className="shrink-0 border border-border/60 px-2 py-1 text-[10px] text-muted-foreground">
                      {action.shortcut}
                    </span>
                  </button>
                );
