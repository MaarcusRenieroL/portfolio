    ...
    >
      <div className="flex w-full items-center justify-between gap-3 lg:grid lg:grid-cols-[1fr_auto_1fr]">
        ...
        >
          ...
          <span className="hidden truncate sm:inline">maarcus.dev</span>
        ...
        <div className="flex shrink-0 items-center justify-self-end gap-2">
          ...
          <button
            ...
            className="grid size-9 place-items-center border border-border/60 bg-background/55 text-muted-foreground transition-colors hover:border-primary/50 hover:bg-primary/5 hover:text-foreground lg:hidden"
