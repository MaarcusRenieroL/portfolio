    ...
    <div className="flex items-center justify-between">
      <div className="flex-1 space-y-1.5">
        ...
        <p className="max-w-md font-mono text-sm text-pretty text-muted-foreground">
          Frontend Engineer focused on building products with extra attention to
          details
        </p>
        ...
        <div className="flex items-center space-x-3 pt-1 font-mono text-sm gap-x-1 text-muted-foreground print:hidden">
          ...
          <Button variant="outline" className="h-8 w-8">
            <Link href="https://www.linkedin.com/in/jephthah-mbah/">
