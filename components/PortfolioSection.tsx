    ...
    return (
        <>
            <div className="h-fit lg:px-32 md:mt-10 sm:mt-3 sm:p-10 xs:p-5">
                ...
                <div className="lg:px-24 md:px-20">
                    ...
                    <div className="lg:grid lg:grid-cols-2 md:grid-cols-1 md:p-10 gap-5">
                        ...
                        <PortfolioCard title="HealthX" content="Give a unique id for every patient and stores the clinical details of every patient and hospital tests done automatically and give access for patients also" image="/healthX.png" date="Nov 2022" url=""/>
                        <PortfolioCard title="Secure Track" content="Fleet Management System to montior the bus routes and to let the students and parents know where their transport is" image="/secure-track.png" date="Jan 2023" url=""/>
                    </div>
                </div>
